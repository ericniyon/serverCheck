...
Route::get('info/details/{id}', [App\Http\Controllers\UserManagementController::class, 'userDetails'])->middleware('auth')->name('info/details');
...
Route::post('/verification',[UserManagementController::class, 'verifying'])->name('verification');
Route::post('/verifying_contractor',[UserManagementController::class, 'verifying_contractor'])->name('verifying_contractor');
...
Route::get('form/view/detail/{id}', [App\Http\Controllers\FormController::class, 'viewDetail'])->middleware('auth')->name('view/updates');


Route::get('staff/view/detail/{id}', [App\Http\Controllers\FormController::class, 'userDetails'])->middleware('auth')->name('staff/updates');
...
Route::post('/verifying',[UserManagementController::class, 'verifying'])->name('verifying');
Route::post('/verifying_contractor',[ContractoController::class, 'verifying_contractor'])->name('verifying_contractor');
